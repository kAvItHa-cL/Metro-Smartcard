...
<%@ Page Language="C#" AutoEventWireup="false" CodeFile="CustomerLoginPage.aspx.cs" Inherits="CustomerLoginPage" %>
...
<body bgcolor="#990099">
    ...
    <div>
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Files/back3.jpg" Style="z-index: 100;
            left: 0px; position: absolute; top: 0px" Width="100%" /><br />
        <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="False" Font-Names="Arial Black"
            ForeColor="white" NavigateUrl="~/Default.aspx" Style="z-index: 101; left: 0px;
            position: absolute; top: 190px">Home</asp:HyperLink>
        <asp:Image ID="Image2" runat="server" ImageAlign="Left" ImageUrl="~/Files/bLogo.GIF"
            Style="z-index: 102; left: 1px; position: absolute; top: 633px" />
        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 103; left: 36px; position: absolute; top: 219px" BackColor="white" Font-Size="XX-Large" ForeColor="purple" Width="335px">Customer Login</asp:HyperLink>
        ...
        <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 106; left: 43px; position: absolute; top: 486px" NavigateUrl="~/CustomerSignUp.aspx" BackColor="white" Font-Size="X-Large" ForeColor="purple" Width="329px">New Customer Signup</asp:HyperLink>
